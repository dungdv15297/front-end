            ...
            <div class="customer-caption">
              ...
              <div class="caption-details">
                ...
                <a href="#" class="btn more-btn1"
                  >{{ $t("about.btn1") }} <i class="ti-angle-right"></i>
                </a>
              </div>
            </div>
          </div>
            ...
            >
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img
                    class="d-block w-100"
                    src="../../../assets/img/hero/servicespage_hero.jpg"
                    alt="First slide"
                  />
                </div>
                <div class="carousel-item">
                  <img
                    class="d-block w-100"
                    src="../../../assets/img/hero/contact_hero.jpg"
                    alt="Second slide"
                  />
                </div>
                <div class="carousel-item">
                  <img
                    class="d-block w-100"
                    src="../../../assets/img/hero/roomspage_hero.jpg"
                    alt="Third slide"
                  />
                </div>
              </div>
...
<style scoped>
.single-slider {
  background-image: url("../../../assets/img/hero/aboutpage_hero.jpg");
